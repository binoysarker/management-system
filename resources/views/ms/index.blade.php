                ...
                <ul class="news_tab">
                  ...
                  <li>
                    <div class="media">
                      <div class="media-left">
                        <a class="news_img" href="#">
                          <img class="media-object" src="{{ asset('img/notice.jpg') }}" alt="img">
                        </a>
                      </div>
                      <div class="media-body">
                       <a href="#">Dummy text of the printing and typesetting industry</a>
          ...
          <div class="ourCourse_content">
            <ul class="course_nav">
              <li>
                <div class="single_course">
                  ...
                  <div class="singCourse_author">
                    <img src="{{ asset('img/author.jpg') }}" alt="img">
              ...
              <li>
                <div class="single_course">
                  <div class="singCourse_imgarea">
                    <img src="{{ asset('img/course-2.jpg') }}" />
                    <div class="mask">                         
                      <a href="#" class="course_more">View Course</a>
                    </div>
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="single_stsTestimonial wow fadeInUp">
                  ...
                  <img class="stsTesti_img" src="{{ asset('img/author.jpg') }}" alt="img">
